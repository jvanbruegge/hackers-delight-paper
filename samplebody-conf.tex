...
This grammar represents a small subset of Typescript. A similar grammar is used in the current implementation. Because of the lazy nature of Haskell parsing this self-recursive definition is comparable easy.
